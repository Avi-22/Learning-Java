...
public class ExpressionTest {
    ...
    public static void main(String args[]) {
        ...
        System.out.println(additionExp);
        Expression a = additionExp.addHint();
    ...
    private static void testHint() {
        ...
        // You may start by experimenting with some of the static expressions given
        // above.
